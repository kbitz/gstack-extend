...
_touches: src/audit/checks/doc-location.ts, src/audit/checks/state-sections.ts, src/audit/cli.ts, src/audit/types.ts, tests/checks-doc-location.test.ts, tests/helpers/audit-ctx.ts, tests/check-group-deps.test.ts, tests/roadmap-audit/docs-dir-absent-with-claude/expected.txt, tests/roadmap-audit/docs-dir-absent-with-audit/files/bin/roadmap-audit, tests/roadmap-audit/docs-dir-absent-with-audit/expected.txt, tests/roadmap-audit/v1-migration-hint/files/docs/ROADMAP.md, tests/roadmap-audit/v1-migration-hint/expected.txt, README.md, skills/roadmap.md, docs/ROADMAP.md_
